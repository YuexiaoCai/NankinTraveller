...
public class SpotActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        android.support.v7.widget.Toolbar toolbar=findViewById(R.id.spot_toolbar);
            ...
            switch (view.getId()) {
                ...
                case R.id.spot_toolbar_like_word:
                    ...
                    else if(ifLiked == 1)
                    {
                        ...
                        textViewLike.setTextColor(Color.parseColor("#888888"));
                ...
                case R.id.spot_toolbar_star_word:
                    ...
                    else if(ifFavorited == 1)
                    {
                        ...
                        textViewFavorite.setTextColor(Color.parseColor("#888888"));
                    ...
                    for (int i = 0; i < data1.size(); i++) {
                        if(data1.size()!=0){
                            ...
                            if(data.equals(title)){//传入的data为标题
                                ...
                                intent1.putExtra("article",new Article(title,type,content,author,url));
