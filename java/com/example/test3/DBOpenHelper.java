...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    public void addArticle(String title,String type,String content,String author,String url){
        db.execSQL("INSERT INTO article (title,type,content,author,url) VALUES(?,?,?,?,?)",new Object[]{title,type,content,author,url});
    }
    ...
    public ArrayList<Article> getAllArticle(){
        ...
        while(cursor.moveToNext()){
            ...
            list.add(new Article(title,type,content,author,url));
        }
        return list;
    }
