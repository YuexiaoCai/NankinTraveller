...
public class TopActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        android.support.v7.widget.Toolbar toolbar=findViewById(R.id.top_toolbar);
    ...
    private void clear()
    {
        ...
        TextView textView2_3 = findViewById(R.id.top_2_text_3);
        TextView textView2_4 = findViewById(R.id.top_2_text_4);
        textView1_1.setTextColor(Color.parseColor("#888888"));
        textView1_2.setTextColor(Color.parseColor("#888888"));
        textView1_3.setTextColor(Color.parseColor("#888888"));
        textView1_4.setTextColor(Color.parseColor("#888888"));
