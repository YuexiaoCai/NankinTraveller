...
public class AddArticle extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        android.support.v7.widget.Toolbar toolbar=findViewById(R.id.addArticle_toolbar);
        ...
        chooseFromAlbum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(AddArticle.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(AddArticle.this, new String[]{ Manifest.permission. WRITE_EXTERNAL_STORAGE }, 1);
                } else {
                    openAlbum();
                }
            }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.addArticle_confirm:    //发布按钮
                ...
                mDBOpenHelper.addArticle(title, type, content, MainActivity.userName,url);
                finish();
                break;
        }
    }
