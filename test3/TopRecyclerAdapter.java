...
public class TopRecyclerAdapter extends RecyclerView.Adapter<TopRecyclerAdapter.ViewHolder>
{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                intent.putExtra(SpotActivity.SPOT_NAME,topRecycler.getTitle());
                intent.putExtra(SpotActivity.SPOT_IMAGE_ID,topRecycler.getImageId());
    ...
    public void onBindViewHolder(ViewHolder holder, int position)
    {
        ...
        Glide.with(mContext).load(topRecycler.getImageId()).into(holder.Image);
    }
